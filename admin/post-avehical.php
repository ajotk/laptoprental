...
<label class="col-sm-2 control-label">Laptop name<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label class="col-sm-2 control-label">Internal Storage<span style="color:red">*</span></label>
<div class="col-sm-4">
